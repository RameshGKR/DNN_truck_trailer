...
if __name__ == "__main__":
    ...
    datafile = "DSL_truck_trailer_multi_stage_loop_run_1\DSL_truck_trailer_multi_stage_loop_run_1\iteration_4\dataset.csv" #use dataset used to train NN so int his case it is one iteration less
