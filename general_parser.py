...
if __name__ == "__main__":
    retrain_for_cegar("counter_examples_file", 4, "DSL_truck_trailer_multi_stage_loop_run_1\DSL_truck_trailer_multi_stage_loop_run_1\iteration_5\dataset.csv", "retrain_cegar_delete_later","DSL_truck_trailer_multi_stage_loop_run_1\DSL_truck_trailer_multi_stage_loop_run_1\iteration_5\output_NN_hypertuning\hyperparameterfile")
