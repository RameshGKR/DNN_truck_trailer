...
if __name__ == "__main__":
	#the order of current_state is (theta1, x1, y1, theta0)
	current_state=vertcat(1.5707963267948966,-0.09999999999999987,0.15,1.5707963267948966)
	output=get_expert_action_truck_trailer(current_state, 0)
	print(output)
